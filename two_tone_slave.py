...
import sip
import threading
import two_tone_slave_epy_block_0 as epy_block_0  # embedded python block



class two_tone_slave(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "two_tone_slave")
        ...
        self.soapy_limesdr_source_0.set_bandwidth(0, 6e6)
        ...
        self.soapy_limesdr_sink_0.set_frequency(0, 440e6)
        self.soapy_limesdr_sink_0.set_frequency_correction(0, 0)
        self.soapy_limesdr_sink_0.set_gain(0, min(max(40.0, -12.0), 64.0))
        ...
        self.epy_block_0 = epy_block_0.blk(threshold=.01, zmq_port=8040)
        ...
        self.connect((self.band_pass_filter_1, 0), (self.qtgui_freq_sink_x_0_0, 0))
        ...
        self.connect((self.soapy_limesdr_source_0, 0), (self.soapy_limesdr_sink_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, 0.9e6, 1.1e6, 1000, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=two_tone_slave, options=None):
