...
import ack_tx_epy_block_0 as epy_block_0  # embedded python block
import ack_tx_epy_block_0_0 as epy_block_0_0  # embedded python block
import sip
import threading



class ack_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "ack_tx")
        ...
        self.epy_block_0_0 = epy_block_0_0.blk(default_value=1)
        self.epy_block_0 = epy_block_0.blk(default_value=1)
        self.blocks_add_xx_0 = blocks.add_vcc(1)
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 400e3, 10, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 200e3, 10, 0, 0)
...
def main(top_block_cls=ack_tx, options=None):
