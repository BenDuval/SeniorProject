...
import default_epy_block_0_0_0 as epy_block_0_0_0  # embedded python block
import sip
import threading
...
class BPSK_TX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.sps = sps = 8
        self.samp_rate = samp_rate = 550e3
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(.7)
        ...
        self.connect((self.blocks_stream_to_tagged_stream_0, 0), (self.epy_block_0_0, 0))
        ...
        self.connect((self.epy_block_0_0, 0), (self.blocks_tagged_stream_mux_0, 1))
        self.connect((self.epy_block_0_0, 0), (self.digital_protocol_formatter_bb_0, 0))
