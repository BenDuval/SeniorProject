...
import BPSK_TX_DATA_epy_block_0 as epy_block_0  # embedded python block
import BPSK_TX_DATA_epy_block_1 as epy_block_1  # embedded python block
import sip



class BPSK_TX_DATA(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "BPSK_TX_DATA")
        ...
        self.soapy_limesdr_source_0.set_bandwidth(0, 5e6)
        self.soapy_limesdr_source_0.set_frequency(0, 445e6)
        self.soapy_limesdr_source_0.set_frequency_correction(0, 0)
        self.soapy_limesdr_source_0.set_gain(0, min(max(30.0, -12.0), 61.0))
        ...
        self.epy_block_1 = epy_block_1.blk(threshold=.01, zmq_port=4010)
        self.epy_block_0 = epy_block_0.repeat_packet_file_source(file_path="/home/ubuntu/Documents/Senior Project/Communication Protocol/SeniorProject/two_tone_slave_data.txt", num_repeats=3)
        ...
        self.connect((self.blocks_rms_xx_0, 0), (self.epy_block_1, 0))
        ...
        self.connect((self.epy_block_1, 0), (self.qtgui_number_sink_2, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_1.set_taps(firdes.band_pass(1, self.samp_rate, 190e3, 210e3, 1000, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=BPSK_TX_DATA, options=None):
