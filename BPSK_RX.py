...
class BPSK_RX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.soapy_limesdr_source_0.set_frequency(0, 433e6)
        ...
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(sps, .0628, rrc_taps, 32, 16, 1.5, 1)
        ...
        self.digital_costas_loop_cc_0 = digital.costas_loop_cc(.0628, 2, False)
        self.digital_correlate_access_code_xx_ts_0 = digital.correlate_access_code_bb_ts('10100001110001001111001011100111',
          1, '')
        ...
        self.connect((self.soapy_limesdr_source_0, 0), (self.analog_agc_xx_0, 0))
